...
class DataAccess
{
	...
	public function getData($fields,$table,$condition)
	{
		if(!$this->_checkTable($table))
		{
    ...
    public function selectAsTable($fields,$table,$condition,$join=NULL,$actions=NULL,$config=null)
    {
	...
	public function createOptions1($labelField,$valField,$table,$condition)
	{
		if($this->_checkTable($table))
		{
			if($this->_checkFieldsIndexed(array($labelField,$valField),$table))
